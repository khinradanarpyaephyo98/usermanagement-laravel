                    ...
                    <div class="container" style="justify-content: space-between; margin-top:20px">
                        <form action="{{route('roles.store') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-light" id="role_name" placeholder="Enter a role name" name="name" required>
                            </div>
                            <h6 class="py-3">Features and Permission</h6>
                        ...
                        <script>
                            document.getElementById('admin_select_all').addEventListener('change', function() {
                                ...
                                let selectAllFeatures = document.querySelectorAll('.select-all-features');
                                selectAllFeatures.forEach(selectAll => selectAll.checked = this.checked);
                            });
                        
                            document.querySelectorAll('.select-all-features').forEach(selectAll => {
