                    ...
                    <div class="container" style="justify-content: space-between; margin-top:20px">
                        <form action="{{route('users.store')}}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control mb-3" id="input-username" placeholder="Enter name" name="name">
                              </div>
                            <div class="form-group">
                                <label for="input-email">Email</label>
                                <input type="email" class="form-control mb-3" id="input-email" placeholder="Enter Email" name="email">
                            </div>
                            <div class="form-group">
                                <label for="input-pwd">Password</label>
                                <input type="text" class="form-control mb-3" id="input-pwd" placeholder="Enter Password" name="password">
                            </div>
                           
                            <label for="input-pwd">Roles</label>
                            <select class="form-select mb-3"  name="role_id">
                                    @foreach ($roles as $role)
                                        <option value={{$role->id}} > {{$role->name }}</option>
                                    @endforeach
                            </select>
                            <button type="submit" class="btn btn-primary mx-auto d-block w-100 mb-2">Create new user </button>        
                        </form>
                    </div>  
                </div>
            </div>
